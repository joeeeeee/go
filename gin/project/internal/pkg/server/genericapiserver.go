...
// type GenericAPIServer gin-example.Engine.
type GenericAPIServer struct {
	...
	*gin.Engine
	...
	// wrapper for gin-example.Engine
...
func (s *GenericAPIServer) InstallAPIs() {
	...
	if s.enableMetrics {
		prometheus := ginprometheus.NewPrometheus("gin-example")
...
// Setup do some setup work for gin-example engine.
