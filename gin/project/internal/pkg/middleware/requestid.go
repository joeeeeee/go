...
// GetLoggerConfig return gin-example.LoggerConfig which will write the logs to specified io.Writer with given gin-example.LogFormatter.
// By default gin-example.DefaultWriter = os.Stdout
...
// GetDefaultLogFormatterWithRequestID returns gin-example.LogFormatter with 'RequestID'.
